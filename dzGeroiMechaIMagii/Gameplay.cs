...
namespace dzTmaSvet
{
    ...
    internal class Gameplay
    {
        ...
        private double Chance() => 
            (double)new Random().Next(0, 100)/ (double)new Random().Next(0, 100);
        ...
        public void printCommand()
        {
            ...
            foreach (BaseUnit unit in command1)
            {
            ...
            foreach(BaseUnit unit in command2)
            {
                Console.WriteLine(unit.ToString());
            }
        }
                ...
                switch (choice)
                {
                    ...
                    case 5:
                        if (unit1.getTage == Tage.healer)
                        {
                            ...
                            {
                                Thread.Sleep(400);
                                BaseUnit healer = unit1;
                                int countHeal = healer.Heal();
                                unit1 = command1.First(); 
                                command1.Remove(command1.First());
